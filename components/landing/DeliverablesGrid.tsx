...
export function DeliverablesGrid() {
  ...
  return (
    <section className="relative z-10 px-5 py-20 sm:px-8 bg-white border-b border-slate-200">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {deliverables.map((item) => (
            <div
              key={item.title}
              className="rounded-2xl border border-slate-200 bg-slate-50/50 p-6 shadow-2xs transition-all hover:bg-white hover:shadow-md hover:border-slate-300"
            >
